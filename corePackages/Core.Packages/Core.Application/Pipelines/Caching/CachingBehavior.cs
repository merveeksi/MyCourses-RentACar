...
{
    //CacheSettings okumamız, almamız gerekiyor
        ...
        CancellationToken cancellationToken)
    {
        ...
        TimeSpan slidingExpiration = request.SlidingExpiration ?? TimeSpan.FromDays(_cacheSettings.SlidingExpiration); //kaç gün verilmişse ona göre ayarla
    ...
    //CacheGroupKey'e cacheKey eklemek
